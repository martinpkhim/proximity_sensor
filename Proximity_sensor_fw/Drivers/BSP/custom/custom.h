...
#define USER_BUTTON_EXTI_LINE              EXTI_LINE_12
#define H_EXTI_12			  hpb_exti[BUTTON_USER]
/**
 * @}
 */
...
#define BUS_USART2_RX_GPIO_PIN GPIO_PIN_15
#define BUS_USART2_RX_GPIO_AF GPIO_AF3_USART2
